...
from core.celery.background_jobs import (
...
class PreprocessingService(metaclass=SingletonMeta):
    ...
    def get_text_pipeline(self, is_init: bool = True) -> PreprocessingPipeline:
        from preprocessing.pipeline import build_text_pipeline
    ...
    def get_image_pipeline(self, is_init: bool) -> PreprocessingPipeline:
        from preprocessing.pipeline import build_image_pipeline
    ...
    def get_audio_pipeline(
        ...
        from preprocessing.pipeline import build_audio_pipeline
    ...
    def get_video_pipeline(
        ...
        from preprocessing.pipeline import build_video_pipeline
