...
def add_audio_processing_steps(pipeline: PreprocessingPipeline) -> None:
    from preprocessing.pipeline.steps.audio.process.convert_to_pcm import convert_to_pcm
    from preprocessing.pipeline.steps.audio.process.create_ffmpeg_probe_audio_metadata import (
        create_ffmpeg_probe_audio_metadata,
    )
    from preprocessing.pipeline.steps.audio.process.generate_automatic_transcription import (
        generate_automatic_transcription,
    )
    from preprocessing.pipeline.steps.audio.process.generate_webp_thumbnail_for_audio import (
