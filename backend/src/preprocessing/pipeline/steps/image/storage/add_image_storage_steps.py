...
def add_image_storage_steps(pipeline: PreprocessingPipeline) -> None:
    from preprocessing.pipeline.steps.image.storage.index_image_document_for_simsearch import (
        index_image_document_for_simsearch,
    )
    from preprocessing.pipeline.steps.image.storage.persist_bbox_annotations import (
