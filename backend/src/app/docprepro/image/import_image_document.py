...
def import_image_document_(doc_file_path: Path, project_id: int, mime_type: str) -> List[PreProImageDoc]:
    # persist in db
    ...
    update_sdoc_status(sdoc_id=ppid.sdoc_id, sdoc_status=SDocStatus.import_image_document)
