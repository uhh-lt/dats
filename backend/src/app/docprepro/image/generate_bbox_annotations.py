...
def generate_bbox_annotations_(ppids: List[PreProImageDoc], object_detection_feature_extractor,
                               object_detection_model) -> List[PreProImageDoc]:
    ...
    for ppid in tqdm(ppids, desc="Generating Automatic BBox Annotations... "):
        ...
        update_sdoc_status(sdoc_id=ppid.sdoc_id, sdoc_status=SDocStatus.generate_bbox_annotations)
