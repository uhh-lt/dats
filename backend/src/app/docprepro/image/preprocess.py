...
from app.docprepro.image.store_bbox_annotations_in_db import store_bbox_annotations_in_db_
...
def generate_bbox_annotations(ppids: List[PreProImageDoc]) -> List[PreProImageDoc]:
    ...
    return generate_bbox_annotations_(ppids, object_detection_feature_extractor, object_detection_model)
...
def generate_image_captions(ppids: List[PreProImageDoc]) -> List[PreProImageDoc]:
    ...
    # todo: can i define the models in the other file?
    return generate_image_captions_(ppids, image_captioning_feature_extractor, image_captioning_model,
