...
extract_text_from_html_and_create_source_mapping = "app.docprepro.text.preprocess.extract_text_from_html_and_create_source_mapping"
...
create_sdoc_links_from_html = "app.docprepro.text.preprocess.create_sdoc_links_from_html"
...
store_span_annotations_in_db = "app.docprepro.text.preprocess.store_span_annotations_in_db"
store_document_in_elasticsearch = "app.docprepro.text.preprocess.store_document_in_elasticsearch"

finish_preprocessing = "app.docprepro.text.preprocess.finish_preprocessing"


def text_document_preprocessing_apply_async(doc_file_path: Path, project_id: int, mime_type: str) -> Any:
    text_document_preprocessing = (
        # import document
            Signature(import_text_document, kwargs={"doc_file_path": doc_file_path,
