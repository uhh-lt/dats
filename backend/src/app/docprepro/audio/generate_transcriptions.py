...
def generate_transcriptions_(ppads: List[PreProAudioDoc], whisper, whisper_model) -> List[PreProAudioDoc]:
    for ppad in tqdm(ppads, desc="Generating transcriptions"):
        update_sdoc_status(sdoc_id=ppad.uncompressed_sdoc_id, sdoc_status=SDocStatus.generate_transcription)
