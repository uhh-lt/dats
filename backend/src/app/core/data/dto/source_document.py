...
class SDocStatus(str, Enum):
    ...
    generate_transcription ="generate_transcription" # "generate transcription"
    ...
    generate_webp_thumbnails_from_video = "generate_webp_thumbnails_from_video" # "generate webp thumbnail from video"
