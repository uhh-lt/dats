...
__settings = {
    ...
    "ITEM_PIPELINES": {
        ...
        "app.core.data.crawler.pipelines.extract_media_urls_from_html_pipeline.ExtractMediaUrlsFromHtmlPipeline": 2,
        "app.core.data.crawler.pipelines.custom_images_download_pipeline.CustomImagesDownloadPipeline": 3,
        "app.core.data.crawler.pipelines.custom_videos_download_pipeline.CustomVideosDownloadPipeline": 4,
        "app.core.data.crawler.pipelines.custom_audios_download_pipeline.CustomAudiosDownloadPipeline": 5,
        "app.core.data.crawler.pipelines.replace_media_urls_with_downloaded_names_pipeline.ReplaceMediaUrlsWithDownloadedNamesPipeline": 6,
        "app.core.data.crawler.pipelines.write_crawled_item_to_disk_pipeline.WriteCrawledItemToDiskPipeline": 7,
    },
    "IMAGES_STORE": None,
