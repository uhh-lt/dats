...
class CRUDFaissSentenceSourceDocumentLink(CRUDBase[FaissSentenceSourceDocumentLinkORM,
...
crud_faiss_sentence_link = CRUDFaissSentenceSourceDocumentLink(FaissSentenceSourceDocumentLinkORM)
