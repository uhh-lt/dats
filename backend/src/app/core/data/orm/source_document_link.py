...
class SourceDocumentLinkORM(ORMBase):
    ...
    parent_source_document_id = Column(Integer, ForeignKey("sourcedocument.id"), index=True)
    ...
    linked_source_document_id = Column(Integer, ForeignKey("sourcedocument.id"), nullable=True, index=True)
