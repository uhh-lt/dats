...
class SourceDocumentLinkORM(ORMBase):
    ...
    parent_source_document_id: Mapped[int] = mapped_column(
    ...
    linked_source_document_id: Mapped[int] = mapped_column(
        Integer,
    ...
    linked_source_document_filename: Mapped[str] = mapped_column(String, index=True)
