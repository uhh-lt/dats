...
class ActionORM(ORMBase):
    ...
    action_type = Column(Integer, nullable=False, index=True)
    ...
    target_id = Column(Integer, ForeignKey('objecthandle.id', ondelete="CASCADE"), nullable=False, index=True)
    target: "ObjectHandleORM" = relationship("ObjectHandleORM",
                                             uselist=False,
                                             passive_deletes=True,
                                             foreign_keys="action.c.target_id")
