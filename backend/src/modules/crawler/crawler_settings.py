...
__settings = {
    ...
    "ITEM_PIPELINES": {
        ...
        "modules.crawler.pipelines.extract_media_urls_from_html_pipeline.ExtractMediaUrlsFromHtmlPipeline": 3,
        "modules.crawler.pipelines.custom_images_download_pipeline.CustomImagesDownloadPipeline": 4,
        "modules.crawler.pipelines.custom_videos_download_pipeline.CustomVideosDownloadPipeline": 5,
        "modules.crawler.pipelines.custom_audios_download_pipeline.CustomAudiosDownloadPipeline": 6,
        "modules.crawler.pipelines.replace_media_urls_with_downloaded_names_pipeline.ReplaceMediaUrlsWithDownloadedNamesPipeline": 7,
        "modules.crawler.pipelines.write_crawled_item_to_disk_pipeline.WriteCrawledItemToDiskPipeline": 8,
    },
    "IMAGES_STORE": None,
