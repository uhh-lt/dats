...
def word_frequency(
    ...
    global_word_count_agg = func.sum(WordFrequencyORM.count).label("global_word_count")
    ...
    result_rows, total_results = builder.execute_query(page_number=None, page_size=None)
...
def word_frequency_export(
    ...
    wf_result = word_frequency(db=db, project_id=project_id, filter=filter, sorts=[])
