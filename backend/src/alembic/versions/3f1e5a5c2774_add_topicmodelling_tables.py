"""add topic modelling tables

Revision ID: 3f1e5a5c2774
Revises: 42c759c92f5b
Create Date: 2025-05-23 13:51:55.611364
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("sdoc_id", "aspect_id", name="uq_sdoc_aspect"),
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_documentaspect_id"), "documentaspect", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("sdoc_id", "topic_id", name="uq_sdoc_topic"),
    )
    op.create_index(op.f("ix_documenttopic_id"), "documenttopic", ["id"], unique=False)
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_documenttopic_id"), table_name="documenttopic")
    ...
    op.drop_index(op.f("ix_documentaspect_id"), table_name="documentaspect")
