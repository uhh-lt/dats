...
@router.patch("/{bbox_id}", tags=tags,
              response_model=Optional[Union[BBoxAnnotationRead, BBoxAnnotationReadResolvedCode]],
...
async def add_memo(*,
    ...
    # TODO Flo: only if the user has access?
    db_obj = crud_memo.create_for_bbox_annotation(db=db, bbox_anno_id=bbox_id, create_dto=memo)
