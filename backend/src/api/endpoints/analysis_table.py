...
async def create(
    *,
    ...
    current_user.assert_in_project(analysis_table.project_id)
    current_user.assert_is_same_user(analysis_table.user_id)
...
async def get_by_id(
    *,
    ...
    current_user.assert_in_same_project_as(Crud.ANALYSIS_TABLE, analysis_table_id)
