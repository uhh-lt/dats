...
import SelectSentenceAnnotationsDialog from "../../../components/SentenceAnnotation/SelectSentenceAnnotationsDialog.tsx";
...
function AddSentenceAnnotationNodeDialog({ projectId, buttonProps, onClick }: AddSentenceAnnotationNodeDialogProps) {
