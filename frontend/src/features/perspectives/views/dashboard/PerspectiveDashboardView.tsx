...
export function PerspectiveDashboardView() {
  ...
  // global server state
  const { data: aspect } = useSuspenseQuery({
        ...
        <Stack spacing={4} direction={"row"} alignItems="flex-start" justifyContent="space-between">
          <Box>
            ...
            <Typography pt={1} color="textSecondary" component="div">
              This map visualizes{" "}
              <b>
                {documentCount} {aspect.modality}s
              </b>
              {aspect.tag_id && (
                <>
                  {" "}
                ...
                title={
                  <Stack spacing={1}>
                    ...
                    <Typography variant="body2">
                      <strong>Embedding Prompt:</strong> {aspect.doc_embedding_prompt}
                    </Typography>
                    {aspect.doc_modification_prompt && (
                      <Typography variant="body2">
                        <strong>Modification Prompt:</strong> {aspect.doc_modification_prompt}
                      </Typography>
                    )}
                    <Typography variant="body2">
                      <strong>Pipeline:</strong> {JSON.stringify(aspect.pipeline_settings, null, 2)}
                    </Typography>
                  </Stack>
                }
              >
