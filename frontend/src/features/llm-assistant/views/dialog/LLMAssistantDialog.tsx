...
const steps: Record<TaskType, string[]> = {
  [TaskType.TAGGING]: ["Select method", "Select tags", "Edit settings", "Edit prompt", "Wait", "View results"],
  ...
  [TaskType.ANNOTATION]: ["Select method", "Select codes", "Edit settings", "Edit prompt", "Wait", "View results"],
...
const contentDict: Record<number, Record<TaskType, React.ReactNode>> = {
  ...
  2: {
    [TaskType.TAGGING]: <SettingsStep />,
    [TaskType.METADATA_EXTRACTION]: <SettingsStep />,
    [TaskType.ANNOTATION]: <SettingsStep />,
    [TaskType.SENTENCE_ANNOTATION]: <SettingsStep />,
  },
  3: {
