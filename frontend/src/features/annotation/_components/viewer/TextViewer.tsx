...
import { TagStyle } from "../../store/annoSlice";
import { DocumentRenderer } from "../document-renderer/DocumentRenderer";
import { SentenceMenu, SentenceMenuHandle } from "./SentenceMenu";
 ...
 */
export function TextViewer({ sdocData: sdocData }: TextViewerProps) {
  // local state
