...
export type ExportJobParameters = {
     ...
     */
    specific_export_job_parameters: (SingleProjectAllDataExportJobParams | SingleProjectAllTagsExportJobParams | SingleUserAllDataExportJobParams | SingleUserAllCodesExportJobParams | SingleUserAllMemosExportJobParams | SingleUserLogbookExportJobParams | SingleDocAllUserAnnotationsExportJobParams | SingleDocSingleUserAnnotationsExportJobParams);
};
