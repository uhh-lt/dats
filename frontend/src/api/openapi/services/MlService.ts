...
/* tslint:disable */
/* eslint-disable */
import type { MLJobParameters_Input } from "../models/MLJobParameters_Input";
...
export class MlService {
   ...
   * @throws ApiError
   */
  public static startMlJob({ requestBody }: { requestBody: MLJobParameters_Input }): CancelablePromise<MLJobRead> {
