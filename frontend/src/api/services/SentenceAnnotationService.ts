...
/* tslint:disable */
/* eslint-disable */
import type { Body_sentenceAnnotation_count_annotations } from "@api/models/Body_sentenceAnnotation_count_annotations";
import type { SentenceAnnotationCreate } from "@api/models/SentenceAnnotationCreate";
import type { SentenceAnnotationRead } from "@api/models/SentenceAnnotationRead";
import type { SentenceAnnotationUpdate } from "@api/models/SentenceAnnotationUpdate";
import type { SentenceAnnotationUpdateBulk } from "@api/models/SentenceAnnotationUpdateBulk";
import type { SentenceAnnotatorResult } from "@api/models/SentenceAnnotatorResult";
