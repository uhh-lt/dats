...
/* tslint:disable */
/* eslint-disable */
import type { Body_spanAnnotation_count_annotations } from "@api/models/Body_spanAnnotation_count_annotations";
import type { SpanAnnotationCreate } from "@api/models/SpanAnnotationCreate";
import type { SpanAnnotationDeleted } from "@api/models/SpanAnnotationDeleted";
import type { SpanAnnotationRead } from "@api/models/SpanAnnotationRead";
import type { SpanAnnotationUpdate } from "@api/models/SpanAnnotationUpdate";
import type { SpanAnnotationUpdateBulk } from "@api/models/SpanAnnotationUpdateBulk";
