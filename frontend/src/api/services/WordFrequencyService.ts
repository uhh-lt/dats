...
/* tslint:disable */
/* eslint-disable */
import type { Body_word_frequency_word_frequency_analysis } from "@api/models/Body_word_frequency_word_frequency_analysis";
import type { Body_word_frequency_word_frequency_analysis_export } from "@api/models/Body_word_frequency_word_frequency_analysis_export";
import type { ColumnInfo_WordFrequencyColumns_ } from "@api/models/ColumnInfo_WordFrequencyColumns_";
import type { WordFrequencyRead } from "@api/models/WordFrequencyRead";
import type { WordFrequencyResult } from "@api/models/WordFrequencyResult";
