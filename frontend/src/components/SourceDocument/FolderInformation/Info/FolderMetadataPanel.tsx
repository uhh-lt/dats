...
import MetadataCreateButton from "../../DocumentInformation/Info/MetadataCreateButton.tsx";
...
function FolderMetadataPanel({ sdocFolderId, filterName }: FolderMetadataPanelProps) {
...
export default memo(FolderMetadataPanel);
