...
4. **Funnel to Text:** _Crucially, this generated caption is then passed directly into the Text Flow._ This means the image's description undergoes entity recognition and indexing, allowing you to find the image using standard text searches!
...
3. _(Note: Currently, frame-by-frame visual analysis for videos is ignored, but it is planned for future development)._
