...
Once you select a task, the dialog guides you through a simple, step-by-step configuration process. *(The following example assumes you chose Span Annotation).*

### Step 1: Select Targets (Codes, Tags, or Metadata)
...
### Step 3: Edit Settings (The Prompt)
...
### Step 4: Wait (Background Processing)
...
## 4\. Reviewing and Applying Results
