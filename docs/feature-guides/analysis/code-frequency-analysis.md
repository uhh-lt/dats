...
- **Frequency per Document:** The list includes a "Count" column. This indicates if the exact same text span was tagged with the identical code multiple times _within the same document_.
