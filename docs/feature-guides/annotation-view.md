...
_The Annotation View is optimized for deep reading and qualitative coding._
...
- **The SYSTEM USER:** During import, DATS automatically identifies entities (like people, locations, or organizations) and tags them under the SYSTEM USER profile using SYSTEM_CODES. Selecting this profile is a great way to see an automated overview of the document's actors.
...
4. _(For Images)_ **Bounding Box Annotation:** Automatically activated when viewing an image document, allowing you to draw rectangles over visual elements.
...
- **LLM Assistant:** The robot icon opens the AI Assistant dialog to help automate your annotation process. _(This feature is covered in detail in the [LLM Assistant Guide](http://docs.google.com/link-to-llm-guide))._
...
_Highlighting text brings up the code selection menu._
...
- ➕ **Duplicate:** Create a second annotation over the exact same span with a _different_ code (useful for applying modifier codes or intersecting concepts).
...
_Manage your hierarchical codebook from the Left Sidebar._
...
_The Right Sidebar provides document context and navigation._
...
3. **RELATED:** _This is crucial for long files!_ If you uploaded a 300-page PDF, DATS split it into smaller documents. This tab lists all the other chunks of that original file. Use the **Next** and **Prev** buttons to easily flip to the next page of your book or article.
4. **MEMOS:** View or create memos attached to the _document as a whole_.
