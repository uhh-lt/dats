...
_(Read more about the design, methodology, and evaluation of this feature in our publication: [Perspectives – Interactive Document Clustering in the Discourse Analysis Tool Suite](https://arxiv.org/abs/2602.15540))._
...
_Review high-level statistics and cluster summaries on the Dashboard._
...
_The Cluster Detail Dialog provides a deeper dive into the AI-generated groups._

## 3\. The Interactive Map View

![Perspectives Map](../assets/perspectives-map.png)
_Use the Map View to visually explore and manually refine the AI's clustering._
