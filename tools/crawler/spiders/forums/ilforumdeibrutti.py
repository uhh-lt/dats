...
class IlforumdeibruttiSpider(SpiderBase):
    name = "ilforumdeibrutti"
    ...
    def __init__(self, thread_id=None, max_pages=10, *args, **kwargs):
        ...
        self.start_urls = [f'https://ilforumdeibrutti.forumfree.it/?t={thread_id}']
    ...
    def parse(self, response, **kwargs):
        ...
        # go to the next thread
            ...
            next_thread = response.css('div.skin_tbl > div > div.title.top.Item.Justify > div.left.Sub > a:nth-child(1)::attr(href)').get()
