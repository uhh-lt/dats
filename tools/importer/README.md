...
```
# import Ortslinien
python importer/dats_importer.py --input_dir /home/9scheld/dats/tools/importer/test_data --backend_url http://localhost:45620/ --project_id 6 --tag_name ortslinien --tag_description ortslinien --doctype text --mime_type text/plain --username SYSTEM@dats.org --password 12SYSTEM34
