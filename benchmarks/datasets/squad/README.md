...
SQuAD is an English extractive question answering dataset.
Each sample contains a context paragraph, a question, and one or more answer spans.

## Where Can It Be Found?

- Hugging Face dataset: https://huggingface.co/datasets/squad
...
Preprocessing is implemented in `squad_dataset_creation.py`.
